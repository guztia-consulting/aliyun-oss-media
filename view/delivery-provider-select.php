...
/* @var \GuztiaConsulting\Aliyun_OSS_Media\Providers\Storage\Storage_Provider $selected_storage_provider */
...
<div class="as3cf-content as3cf-delivery-provider-select">
	...
	<div class="as3cf-delivery-provider-select-options">
		...
		/* @var \GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\Delivery_Provider $delivery_provider_class */
		foreach ( $delivery_providers as $delivery_provider_key => $delivery_provider_class ) {
			/* @var \GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\Delivery_Provider $delivery_provider */
			...
			$delivery_provider_sub_option          = 'GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\Delivery_Provider' !== get_parent_class( $delivery_provider );
		...
		foreach ( $delivery_providers_tree as $delivery_provider_key => $delivery_provider_details ) {
			...
			>
				...
				if ( $delivery_provider_selected && $delivery_provider_defined ) {
					echo '<span class="as3cf-defined-in-config">' . __( 'defined in your theme', 'amazon-s3-and-cloudfront' ) . '</span>';
				}
				?>
