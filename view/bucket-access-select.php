<div class="as3cf-change-bucket-access-prompt">
	...
	if ( is_subclass_of( $this->get_provider_client(), 'GuztiaConsulting\Aliyun_OSS_Media\Providers\Storage\Storage_Provider' ) ){
		try {
	...
	if ( ! empty( $delivery_provider ) && is_a( $delivery_provider, '\GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\Delivery_Provider' ) && \GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\AWS_CloudFront::get_provider_key_name() === $delivery_provider->get_provider_key_name() ) {
