...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\StreamDecoratorTrait;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\BufferStream;
 ...
 */
class WriteStream implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Psr\Http\Message\StreamInterface
{
     ...
     * }
     */
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Upload\AbstractUploader $uploader = null, $options = [])
    {
        if ($uploader) {
        ...
        $this->stream = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\BufferStream($this->chunkSize);
    }
    /**
