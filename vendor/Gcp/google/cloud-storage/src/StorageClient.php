...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\FetchAuthTokenInterface;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\ArrayTrait;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\ClientTrait;
...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Upload\SignedUrlUploader;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Connection\ConnectionInterface;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Connection\Rest;
...
class StorageClient
{
    ...
    public function __construct(array $config = [])
    {
        ...
        $this->connection = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Connection\Rest($this->configureAuthentication($config) + ['projectId' => $this->projectId]);
    }
    /**
    ...
    public function bucket($name, $userProject = false)
    {
        ...
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Bucket($this->connection, $name, ['requesterProjectId' => $userProject]);
    }
    /**
    ...
    public function buckets(array $options = [])
    {
        ...
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Iterator\ItemIterator(new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Iterator\PageIterator(function (array $bucket) use($userProject) {
            return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Bucket($this->connection, $bucket['name'], $bucket + ['requesterProjectId' => $userProject]);
    ...
    public function createBucket($name, array $options = [])
    {
        ...
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Bucket($this->connection, $name, $response + ['requesterProjectId' => $userProject]);
    }
    /**
    ...
    {
        return \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\StreamWrapper::register($this, $protocol);
    }
    /**
    ...
    {
        \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\StreamWrapper::unregister($protocol);
    }
    /**
    ...
    {
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Upload\SignedUrlUploader($this->connection->requestWrapper(), $data, $uri, $options);
    }
    /**
    ...
    {
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Timestamp($timestamp, $nanoSeconds);
    }
    /**
    ...
    public function hmacKeys(array $options = [])
    {
        ...
        $resultLimit = $this->pluck('resultLimit', $options, false);
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Iterator\ItemIterator(new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Iterator\PageIterator(function (array $metadata) use($options) {
    ...
    public function hmacKey($accessId, $projectId = null, array $metadata = [])
    {
        ...
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\HmacKey($this->connection, $projectId ?: $this->projectId, $accessId, $metadata);
    }
    /**
    ...
    public function createHmacKey($serviceAccountEmail, array $options = [])
    {
        ...
        $key = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\HmacKey($this->connection, $options['projectId'], $res['metadata']['accessId'], $res['metadata']);
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\CreatedHmacKey($key, $res['secret']);
    }
    /**
