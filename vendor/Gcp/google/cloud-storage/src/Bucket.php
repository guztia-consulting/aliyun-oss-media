 ...
 */
namespace GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage;

use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\ArrayTrait;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Exception\GoogleException;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Exception\NotFoundException;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Exception\ServiceException;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Iam\Iam;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Iterator\ItemIterator;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Iterator\PageIterator;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Timestamp;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Upload\ResumableUploader;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Upload\StreamableUploader;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\PubSub\Topic;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Connection\ConnectionInterface;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Connection\IamBucket;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\SigningHelper;
...
class Bucket
{
     ...
     */
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Connection\ConnectionInterface $connection, $name, array $info = [])
    {
        ...
        $this->acl = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Acl($this->connection, 'bucketAccessControls', $this->identity);
        $this->defaultAcl = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Acl($this->connection, 'defaultObjectAccessControls', $this->identity);
    }
    /**
    ...
    public function upload($data, array $options = [])
    {
        ...
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\StorageObject($this->connection, $response['name'], $this->identity['bucket'], $response['generation'], $response, $encryptionKey, $encryptionKeySHA256);
    }
    /**
    ...
    public function object($name, array $options = [])
    {
        ...
        $encryptionKey = isset($options['encryptionKey']) ? $options['encryptionKey'] : null;
        $encryptionKeySHA256 = isset($options['encryptionKeySHA256']) ? $options['encryptionKeySHA256'] : null;
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\StorageObject($this->connection, $name, $this->identity['bucket'], $generation, array_filter(['requesterProjectId' => $this->identity['userProject']]), $encryptionKey, $encryptionKeySHA256);
    }
    /**
    ...
    public function objects(array $options = [])
    {
        ...
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\ObjectIterator(new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\ObjectPageIterator(function (array $object) {
            return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\StorageObject($this->connection, $object['name'], $this->identity['bucket'], isset($object['generation']) ? $object['generation'] : null, $object + array_filter(['requesterProjectId' => $this->identity['userProject']]));
    ...
    public function createNotification($topic, array $options = [])
    {
        ...
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Notification($this->connection, $res['id'], $this->identity['bucket'], $res + ['requesterProjectId' => $this->identity['userProject']]);
    }
    /**
    ...
    {
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Notification($this->connection, $id, $this->identity['bucket'], ['requesterProjectId' => $this->identity['userProject']]);
    }
    /**
    ...
    {
        $resultLimit = $this->pluck('resultLimit', $options, false);
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Iterator\ItemIterator(new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Iterator\PageIterator(function (array $notification) {
            return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Notification($this->connection, $notification['id'], $this->identity['bucket'], $notification + ['requesterProjectId' => $this->identity['userProject']]);
    ...
    public function compose(array $sourceObjects, $name, array $options = [])
    {
        ...
        if (!isset($options['destination']['contentType'])) {
            $options['destination']['contentType'] = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\mimetype_from_filename($name);
        }
        ...
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\StorageObject($this->connection, $response['name'], $this->identity['bucket'], $response['generation'], $response + array_filter(['requesterProjectId' => $this->identity['userProject']]));
    }
    /**
    ...
    {
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Lifecycle($lifecycle);
    }
    /**
    ...
    public function isWritable($file = null)
    {
        ...
        $uploader = $this->getResumableUploader(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\stream_for(''), ['name' => $file]);
        try {
    ...
    {
        if (!$this->iam) {
            $this->iam = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Iam\Iam(new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Connection\IamBucket($this->connection), $this->identity['bucket'], ['parent' => null, 'args' => $this->identity]);
        }
        return $this->iam;
    }
    /**
    ...
    public function signedUrl($expires, array $options = [])
    {
        ...
        $signingHelper = $this->pluck('helper', $options, false) ?: \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\SigningHelper::getHelper();
    ...
    private function getFormattedTopic($topic)
    {
        ...
        if (!$this->projectId) {
            throw new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Exception\GoogleException('No project ID was provided, ' . 'and we were unable to detect a default project ID.');
        }
