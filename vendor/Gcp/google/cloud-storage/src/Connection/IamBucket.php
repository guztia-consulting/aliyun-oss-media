...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Iam\IamConnectionInterface;
/**
 * IAM Implementation for GCS Buckets
 */
class IamBucket implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Iam\IamConnectionInterface
{
    /**
     ...
     */
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Connection\ConnectionInterface $connection)
    {
