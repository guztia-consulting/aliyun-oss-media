...
class HmacKey
{
     ...
     */
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\Connection\ConnectionInterface $connection, $projectId, $accessId, array $info = [])
    {
