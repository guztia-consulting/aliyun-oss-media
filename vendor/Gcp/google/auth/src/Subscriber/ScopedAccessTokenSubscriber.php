...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\CacheTrait;
 ...
 */
class ScopedAccessTokenSubscriber implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Event\SubscriberInterface
{
    use CacheTrait;
     ...
     */
    public function __construct(callable $tokenFunc, $scopes, array $cacheConfig = null, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Psr\Cache\CacheItemPoolInterface $cache = null)
    {
