...
class GCECache
{
     ...
     */
    public function __construct(array $cacheConfig = null, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Psr\Cache\CacheItemPoolInterface $cache = null)
    {
        $this->cache = $cache;
    ...
    public function onGce(callable $httpHandler = null)
    {
        ...
        if (is_null($onGce)) {
            $onGce = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\Credentials\GCECredentials::onGce($httpHandler);
