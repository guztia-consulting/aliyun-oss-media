 ...
 */
namespace GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\Credentials;

use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\CredentialsLoader;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\GetQuotaProjectInterface;
...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\Iam;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\ProjectIdProviderInterface;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\SignBlobInterface;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Exception\ClientException;
...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Exception\ServerException;
 ...
 */
class GCECredentials extends \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\CredentialsLoader implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\SignBlobInterface, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\ProjectIdProviderInterface, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\GetQuotaProjectInterface
{
    // phpcs:disable
     ...
     */
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\Iam $iam = null, $scope = null, $targetAudience = null, $quotaProject = null, $serviceAccountIdentity = null)
    {
        $this->iam = $iam;
    ...
    {
        $httpHandler = $httpHandler ?: \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\HttpHandler\HttpHandlerFactory::build(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\HttpHandler\HttpClientCache::getHttpClient());
        ...
        for ($i = 1; $i <= self::MAX_COMPUTE_PING_TRIES; $i++) {
            try {
                ...
                // the metadata resolution was particularly slow. The latter case is
                // "unlikely".
                $resp = $httpHandler(new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\Request('GET', $checkUri, [self::FLAVOR_HEADER => 'Google']), ['timeout' => self::COMPUTE_PING_CONNECTION_TIMEOUT_S]);
    ...
    {
        $httpHandler = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\HttpHandler\HttpHandlerFactory::build(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\HttpHandler\HttpClientCache::getHttpClient());
        ...
        $signer = $this->iam ?: new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\Iam($httpHandler);
    ...
    {
        $resp = $httpHandler(new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\Request('GET', $uri, [self::FLAVOR_HEADER => 'Google']));
