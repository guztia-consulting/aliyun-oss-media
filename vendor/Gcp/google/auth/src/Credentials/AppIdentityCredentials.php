 ...
 */
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\google\appengine\api\app_identity\AppIdentityService;
 ...
 * ```
 */
class AppIdentityCredentials extends \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\CredentialsLoader implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\SignBlobInterface, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\ProjectIdProviderInterface
{
    /**
    ...
    public function fetchAuthToken(callable $httpHandler = null)
    {
        ...
        $token = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\google\appengine\api\app_identity\AppIdentityService::getAccessToken($scope);
    ...
    {
        $this->checkAppEngineContext();
        return base64_encode(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\google\appengine\api\app_identity\AppIdentityService::signForApp($stringToSign)['signature']);
    }
    /**
    ...
    public function getProjectId(callable $httpHander = null)
    {
        ...
        return \GuztiaConsulting\Aliyun_OSS_Media\Gcp\google\appengine\api\app_identity\AppIdentityService::getApplicationId();
    }
    /**
    ...
    public function getClientName(callable $httpHandler = null)
    {
        $this->checkAppEngineContext();
        if (!$this->clientName) {
            $this->clientName = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\google\appengine\api\app_identity\AppIdentityService::getServiceAccountName();
        }
    ...
    {
        if (!self::onAppEngine() || !class_exists('GuztiaConsulting\\Aliyun_OSS_Media\\Gcp\\google\\appengine\\api\\app_identity\\AppIdentityService')) {
