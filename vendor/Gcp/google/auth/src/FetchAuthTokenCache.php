...
class FetchAuthTokenCache implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\FetchAuthTokenInterface, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\GetQuotaProjectInterface, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\SignBlobInterface, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\ProjectIdProviderInterface, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\UpdateMetadataInterface
{
     ...
     */
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\FetchAuthTokenInterface $fetcher, array $cacheConfig = null, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Psr\Cache\CacheItemPoolInterface $cache)
    {
    ...
    public function signBlob($stringToSign, $forceOpenSsl = false)
    {
        if (!$this->fetcher instanceof SignBlobInterface) {
            throw new \RuntimeException('Credentials fetcher does not implement ' . 'GuztiaConsulting\\Aliyun_OSS_Media\\Gcp\\Google\\Auth\\SignBlobInterface');
        }
    ...
    public function getProjectId(callable $httpHandler = null)
    {
        if (!$this->fetcher instanceof ProjectIdProviderInterface) {
            throw new \RuntimeException('Credentials fetcher does not implement ' . 'GuztiaConsulting\\Aliyun_OSS_Media\\Gcp\\Google\\Auth\\ProvidesProjectIdInterface');
        }
    ...
    public function updateMetadata($metadata, $authUri = null, callable $httpHandler = null)
    {
        if (!$this->fetcher instanceof UpdateMetadataInterface) {
            throw new \RuntimeException('Credentials fetcher does not implement ' . 'GuztiaConsulting\\Aliyun_OSS_Media\\Gcp\\Google\\Auth\\UpdateMetadataInterface');
        }
