...
class Iam
{
    ...
    public function signBlob($email, $accessToken, $stringToSign, array $delegates = [])
    {
        ...
        $request = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\Request('POST', $uri, $headers, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\stream_for(json_encode($body)));
