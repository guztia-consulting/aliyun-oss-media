 ...
 */
class OAuth2 implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\FetchAuthTokenInterface
{
    ...
    public function generateCredentialsRequest()
    {
        ...
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\Request('POST', $uri, $headers, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\build_query($params));
    }
    /**
     ...
     * @throws \Exception
     */
    public function parseTokenResponse(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Psr\Http\Message\ResponseInterface $resp)
    {
    ...
    public function buildFullAuthorizationUri(array $config = [])
    {
        ...
        $existingParams = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\parse_query($result->getQuery());
        $result = $result->withQuery(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\build_query(array_merge($existingParams, $params)));
    ...
    private function coerceUri($uri)
    {
        ...
        return \GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\uri_for($uri);
    }
    /**
    ...
    {
        if (class_exists('GuztiaConsulting\\Aliyun_OSS_Media\\Gcp\\Firebase\\JWT\\JWT')) {
            return \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Firebase\JWT\JWT::decode($idToken, $publicKey, $allowedAlgs);
        }
    ...
    {
        if (class_exists('GuztiaConsulting\\Aliyun_OSS_Media\\Gcp\\Firebase\\JWT\\JWT')) {
            return \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Firebase\JWT\JWT::encode($assertion, $signingKey, $signingAlgorithm, $signingKeyId);
        }
