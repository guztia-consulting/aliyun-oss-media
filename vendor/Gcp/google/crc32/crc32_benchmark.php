...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\Google;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\PHP;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\PHPSlicedBy4;
...
foreach (array(256, 4096, 1048576, 16777216) as $chunk_size) {
    \test(new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\PHP(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\CRC32::CASTAGNOLI), $chunk_size);
    \test(new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\PHPSlicedBy4(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\CRC32::CASTAGNOLI), $chunk_size);
    // Using IEEE, avoiding the CASTAGNOLI version crc32c.so adds.
    \test(new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\Builtin(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\CRC32::IEEE), $chunk_size);
    \test(new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\Google(), $chunk_size);
}
