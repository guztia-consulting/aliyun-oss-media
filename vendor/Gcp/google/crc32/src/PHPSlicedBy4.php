...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\CRCTrait;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\Table;
/**
 ...
 */
final class PHPSlicedBy4 implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\CRCInterface
{
    use CRCTrait;
    ...
    public function __construct($polynomial)
    {
        ...
        $this->table = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\Table::create4($polynomial);
        $this->reset();
    }
