 ...
 */
namespace GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32;
...
class CRC32
{
    ...
    {
        if (\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\Google::supports($polynomial) && function_exists('crc32c')) {
            return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\Google();
        }
        if (\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\Builtin::supports($polynomial)) {
            return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\Builtin($polynomial);
        }
        // Fallback to the pure PHP version
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\PHP($polynomial);
    }
    /**
