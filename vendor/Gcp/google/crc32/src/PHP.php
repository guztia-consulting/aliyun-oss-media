 ...
 */
final class PHP implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\CRCInterface
{
    use CRCTrait;
    ...
    public function __construct($polynomial)
    {
        ...
        $this->table = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\Table::get($polynomial);
        $this->reset();
    }
