...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\CRCInterface;
/**
 * A CRC32 implementation based on the PHP hash functions.
 */
final class Builtin implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\CRCInterface
{
    private $hc;
    private static $mapping = [\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\CRC32::IEEE => 'crc32b', \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\CRC32\CRC32::CASTAGNOLI => 'crc32c'];
    /**
