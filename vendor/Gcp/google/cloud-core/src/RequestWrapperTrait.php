...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\ApplicationDefaultCredentials;
...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\FetchAuthTokenCache;
...
trait RequestWrapperTrait
{
    ...
    {
        $config += ['authCache' => new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\Cache\MemoryCacheItemPool(), 'authCacheOptions' => [], 'credentialsFetcher' => null, 'keyFile' => null, 'requestTimeout' => null, 'retries' => 3, 'scopes' => null, 'quotaProject' => null];
    ...
    public function getCredentialsFetcher()
    {
        ...
        if ($this->credentialsFetcher) {
            ...
            $fetcher = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\CredentialsLoader::makeCredentials($this->scopes, $this->keyFile);
        } else {
            try {
                $fetcher = $this->getADC();
            } catch (\DomainException $ex) {
                $fetcher = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\AnonymousCredentials();
            }
        }
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\FetchAuthTokenCache($fetcher, $this->authCacheOptions, $this->authCache);
    }
    /**
    ...
    {
        return \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\ApplicationDefaultCredentials::getCredentials($this->scopes, $this->authHttpHandler, null, null, $this->quotaProject);
    }
}
