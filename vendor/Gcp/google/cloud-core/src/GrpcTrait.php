...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\ApiCore\CredentialsWrapper;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\ArrayTrait;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Duration;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Exception\NotFoundException;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\GrpcRequestWrapper;
...
trait GrpcTrait
{
     ...
     */
    public function setRequestWrapper(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\GrpcRequestWrapper $requestWrapper)
    {
    ...
    private function getGaxConfig($version, callable $authHttpHandler = null)
    {
        ...
        if (class_exists(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\ApiCore\CredentialsWrapper::class)) {
            $config['credentials'] = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\ApiCore\CredentialsWrapper($this->requestWrapper->getCredentialsFetcher(), $authHttpHandler);
        } else {
    ...
    private function formatValueForApi($value)
    {
        ...
        switch ($type) {
            ...
            case 'NULL':
                return ['null_value' => \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Protobuf\NullValue::NULL_VALUE];
            case 'array':
