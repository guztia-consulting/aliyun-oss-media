 ...
 *      upgrading.
 */
class SysvProcessor implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Batch\ProcessItemInterface
{
    ...
    public function submit($item, $idNum)
    {
        ...
        if ($result === false) {
            ...
            if ($result === false) {
                @unlink($tempFile);
                throw new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Batch\QueueOverflowException();
            }
        }
    }
    /**
