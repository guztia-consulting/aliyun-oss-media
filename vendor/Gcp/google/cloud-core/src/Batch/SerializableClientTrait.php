...
trait SerializableClientTrait
{
    ...
    {
        if (class_exists(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Opis\Closure\SerializableClosure::class)) {
            return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Batch\OpisClosureSerializer();
        }
    }
}
