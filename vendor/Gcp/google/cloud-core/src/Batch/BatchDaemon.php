...
class BatchDaemon
{
    ...
    public function __construct($entrypoint)
    {
        ...
        $this->runner = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Batch\BatchRunner(new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Batch\SysvConfigStorage(), new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Batch\SysvProcessor());
        $this->shutdown = false;
