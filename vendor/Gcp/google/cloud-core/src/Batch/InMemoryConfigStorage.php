 ...
 *      upgrading.
 */
final class InMemoryConfigStorage implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Batch\ConfigStorageInterface, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Batch\ProcessItemInterface
{
    ...
    public static function getInstance()
    {
        ...
        if ($instance === null) {
            $instance = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Batch\InMemoryConfigStorage();
        }
        return $instance;
    }
    /**
    ...
    {
        $this->config = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Batch\JobConfig();
     ...
     * @return bool
     */
    public function save(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Batch\JobConfig $config)
    {
        $this->config = $config;
        return true;
    }
