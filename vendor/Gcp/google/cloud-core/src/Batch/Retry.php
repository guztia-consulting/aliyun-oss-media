...
class Retry
{
     ...
     */
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Batch\BatchRunner $runner = null)
    {
        $this->runner = $runner ?: new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Batch\BatchRunner();
