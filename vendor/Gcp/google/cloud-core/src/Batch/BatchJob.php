 ...
 *      upgrading.
 */
class BatchJob implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Batch\JobInterface
{
    ...
    public function run()
    {
        ...
        while (true) {
            ...
            if (count($items) >= $this->batchSize || count($items) > 0 && (microtime(true) > $lastInvoked + $this->callPeriod || $this->shutdown)) {
