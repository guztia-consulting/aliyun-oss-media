 ...
 *      upgrading.
 */
class SysvConfigStorage implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Batch\ConfigStorageInterface
{
    const VAR_KEY = 1;
    ...
    public function load()
    {
        ...
        if (!shm_has_var($shmid, self::VAR_KEY)) {
            $result = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Batch\JobConfig();
        } else {
