 ...
 */
namespace GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Lock;

use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Symfony\Component\Lock\LockInterface as SymfonyLockInterface;
/**
 * Symfony lock component adapter.
 */
class SymfonyLockAdapter implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Lock\LockInterface
{
    use LockTrait;
    /**
     ...
     */
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Symfony\Component\Lock\LockInterface $lock)
    {
        $this->lock = $lock;
    }
    /**
