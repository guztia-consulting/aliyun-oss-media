...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate;
/**
...
trait UriTrait
{
    ...
    {
        $template = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate();
    ...
    public function buildUriWithQuery($uri, array $query)
    {
        ...
        return \GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\uri_for($uri)->withQuery(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\build_query($query));
    }
}
