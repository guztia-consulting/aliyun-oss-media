...
class LongRunningOperation
{
     ...
     */
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\LongRunning\LongRunningConnectionInterface $connection, $name, array $callablesMap, array $info = [])
    {
