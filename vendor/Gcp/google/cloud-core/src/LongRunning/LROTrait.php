 ...
 */
namespace GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\LongRunning;
...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\LongRunning\LongRunningConnectionInterface;
/**
...
trait LROTrait
{
     ...
     *        may be listed.
     */
    private function setLroProperties(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\LongRunning\LongRunningConnectionInterface $lroConnection, array $lroCallables, $resource = null)
    {
    ...
    {
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\LongRunning\LongRunningOperation($this->lroConnection, $operationName, $this->lroCallables, $info);
    }
    /**
    ...
    public function longRunningOperations(array $options = [])
    {
        ...
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Iterator\ItemIterator(new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Iterator\PageIterator(function (array $operation) {
