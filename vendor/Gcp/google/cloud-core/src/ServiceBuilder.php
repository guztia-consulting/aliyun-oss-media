...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\HttpHandler\Guzzle5HttpHandler;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\HttpHandler\Guzzle6HttpHandler;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\HttpHandler\HttpHandlerFactory;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\BigQuery\BigQueryClient;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Datastore\DatastoreClient;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Firestore\FirestoreClient;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Language\LanguageClient;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Logging\LoggingClient;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\PubSub\PubSubClient;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Spanner\SpannerClient;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Speech\SpeechClient;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\StorageClient;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Trace\TraceClient;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Translate\TranslateClient;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Vision\VisionClient;
...
class ServiceBuilder
{
    ...
    {
        return $this->createClient(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\BigQuery\BigQueryClient::class, 'bigquery', $config);
    }
    /**
    ...
    {
        return $this->createClient(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Datastore\DatastoreClient::class, 'datastore', $config);
    }
    /**
    ...
    {
        return $this->createClient(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Firestore\FirestoreClient::class, 'firestore', $config);
    }
    /**
    ...
    {
        return $this->createClient(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Logging\LoggingClient::class, 'logging', $config);
    }
    /**
    ...
    {
        return $this->createClient(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Language\LanguageClient::class, 'language', $config);
    }
    /**
    ...
    {
        return $this->createClient(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\PubSub\PubSubClient::class, 'pubsub', $config);
    }
    /**
    ...
    {
        return $this->createClient(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Spanner\SpannerClient::class, 'spanner', $config);
    }
    /**
    ...
    {
        return $this->createClient(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Speech\SpeechClient::class, 'speech', $config);
    }
    /**
    ...
    {
        return $this->createClient(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Storage\StorageClient::class, 'storage', $config);
    }
    /**
    ...
    {
        return $this->createClient(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Trace\TraceClient::class, 'trace', $config);
    }
    /**
    ...
    {
        return $this->createClient(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Vision\VisionClient::class, 'vision', $config);
    }
    /**
    ...
    {
        return $this->createClient(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Translate\TranslateClient::class, 'translate', $config);
    }
    /**
    ...
    private function resolveConfig(array $config)
    {
        if (!isset($config['httpHandler'])) {
            $config['httpHandler'] = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\HttpHandler\HttpHandlerFactory::build();
        }
        if (!isset($config['asyncHttpHandler'])) {
            ...
            $config['asyncHttpHandler'] = $isGuzzleHandler ? [$config['httpHandler'], 'async'] : [\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\HttpHandler\HttpHandlerFactory::build(), 'async'];
        }
