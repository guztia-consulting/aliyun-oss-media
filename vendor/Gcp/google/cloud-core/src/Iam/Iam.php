 ...
 */
namespace GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Iam;
...
class Iam
{
     ...
     * @access private
     */
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Iam\IamConnectionInterface $connection, $resource, array $options = [])
    {
