 ...
 */
class StreamableUploader extends \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Upload\ResumableUploader
{
    /**
    ...
    public function upload($writeSize = null)
    {
        ...
        try {
            ...
            throw new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Exception\GoogleException("Upload failed. Please use this URI to resume your upload: {$resumeUri}", $ex->getCode(), $ex);
        }
