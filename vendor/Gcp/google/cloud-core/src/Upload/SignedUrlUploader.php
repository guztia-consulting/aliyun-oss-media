 ...
 */
class SignedUrlUploader extends \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Upload\ResumableUploader
{
    /**
    ...
    protected function createResumeUri()
    {
        ...
        $request = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\Request('POST', $this->uri, $headers);
