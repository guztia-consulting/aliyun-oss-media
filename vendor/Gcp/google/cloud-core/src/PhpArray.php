...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\DrSlump\Protobuf;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\google\protobuf\Value;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\google\protobuf\ListValue;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\google\protobuf\NullValue;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\google\protobuf\Struct;
/**
 ...
 * @codeCoverageIgnore
 */
class PhpArray extends \GuztiaConsulting\Aliyun_OSS_Media\Gcp\DrSlump\Protobuf\Codec\PhpArray
{
    /**
     * @var array
     */
     ...
     * overhead.
     */
    protected function encodeMessage(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\DrSlump\Protobuf\Message $message)
    {
        $descriptor = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\DrSlump\Protobuf::getRegistry()->getDescriptor($message);
        $data = [];
     ...
     */
    protected function decodeMessage(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\DrSlump\Protobuf\Message $message, $data)
    {
        ...
        foreach ($data as $key => $v) {
            ...
            // Unknown field found
            if (!$field) {
                $unknown = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\DrSlump\Protobuf\Codec\PhpArray\Unknown($key, gettype($v), $v);
    ...
    protected function filterValue($value, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\DrSlump\Protobuf\Field $field)
    {
        if (trim($field->getReference(), '\\') === \GuztiaConsulting\Aliyun_OSS_Media\Gcp\google\protobuf\NullValue::class) {
            return null;
        }
