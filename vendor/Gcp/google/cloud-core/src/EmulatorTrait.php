...
trait EmulatorTrait
{
    ...
    private function emulatorGapicConfig($emulatorHost)
    {
        ...
        return ['apiEndpoint' => $emulatorHost, 'transportConfig' => ['grpc' => ['stubOpts' => ['credentials' => \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Grpc\ChannelCredentials::createInsecure()]]]];
    }
    /**
