...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Handler\StreamHandler;
 ...
 */
class AppEngineFlexHandlerV2 extends \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Handler\StreamHandler
{
    /**
     ...
     */
    public function __construct($level = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::INFO, $bubble = true, $filePermission = 0640, $useLocking = false, $stream = null)
    {
        if ($stream === null) {
            $pid = getmypid();
    ...
    {
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Logger\AppEngineFlexFormatterV2();
    }
}
