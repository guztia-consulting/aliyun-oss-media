 ...
 */
class AppEngineFlexHandler extends \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Handler\StreamHandler
{
    /**
    ...
    {
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Logger\AppEngineFlexFormatter();
    }
}
