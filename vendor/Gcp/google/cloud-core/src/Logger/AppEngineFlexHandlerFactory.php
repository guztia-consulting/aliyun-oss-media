 ...
 */
namespace GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Logger;
...
class AppEngineFlexHandlerFactory
{
     ...
     */
    public static function build($level = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::INFO, $bubble = true, $filePermission = 0640, $useLocking = false, $stream = null)
    {
        $version = defined('GuztiaConsulting\\Aliyun_OSS_Media\\Gcp\\Monolog\\Logger::API') ? \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::API : 1;
        switch ($version) {
            case 1:
                return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Logger\AppEngineFlexHandler($level, $bubble, $filePermission, $useLocking, $stream);
            case 2:
                return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Logger\AppEngineFlexHandlerV2($level, $bubble, $filePermission, $useLocking, $stream);
            default:
