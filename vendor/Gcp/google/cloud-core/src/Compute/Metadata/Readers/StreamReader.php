 ...
 */
class StreamReader implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Compute\Metadata\Readers\ReaderInterface
{
    /**
    ...
    {
        $options = ['http' => ['method' => 'GET', 'header' => \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Auth\Credentials\GCECredentials::FLAVOR_HEADER . ': Google']];
