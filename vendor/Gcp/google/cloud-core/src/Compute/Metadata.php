 ...
 */
namespace GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Compute;

use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Compute\Metadata\Readers\HttpHandlerReader;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Compute\Metadata\Readers\ReaderInterface;
/**
...
class Metadata
{
     ...
     */
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Compute\Metadata\Readers\ReaderInterface $reader = null)
    {
        $this->reader = $reader ?: new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Compute\Metadata\Readers\HttpHandlerReader();
    }
    /**
     ...
     */
    public function setReader(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Google\Cloud\Core\Compute\Metadata\Readers\ReaderInterface $reader)
    {
        $this->reader = $reader;
    }
    /**
