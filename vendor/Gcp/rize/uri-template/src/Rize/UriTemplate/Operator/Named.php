 ...
 */
class Named extends \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Operator\Abstraction
{
    public function toRegex(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Parser $parser, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Node\Variable $var)
    {
        $regex = null;
        $name = $var->name;
        $value = $this->getRegex();
    ...
    public function encodeExplodeVars(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Parser $parser, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Node\Variable $var, $data)
    {
