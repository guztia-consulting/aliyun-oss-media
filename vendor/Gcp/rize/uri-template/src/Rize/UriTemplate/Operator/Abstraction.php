...
namespace GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Operator;

use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Node;
...
abstract class Abstraction
{
    ...
    public abstract function toRegex(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Parser $parser, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Node\Variable $var);
    public function expand(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Parser $parser, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Node\Variable $var, array $params = array())
    {
        $options = $var->options;
        $name = $var->name;
    ...
    public function expandString(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Parser $parser, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Node\Variable $var, $val)
    {
        $val = (string) $val;
        $options = $var->options;
        $result = null;
     ...
     * @return null|string
     */
    public function expandNonExplode(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Parser $parser, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Node\Variable $var, array $val)
    {
        if (empty($val)) {
            return null;
        }
     ...
     * @return null|string
     */
    public function expandExplode(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Parser $parser, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Node\Variable $var, array $val)
    {
        if (empty($val)) {
            return null;
        }
     ...
     */
    public function encode(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Parser $parser, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Node\Variable $var, $values)
    {
        $values = (array) $values;
        $list = isset($values[0]);
     ...
     */
    public function decode(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Parser $parser, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Node\Variable $var, $values)
    {
     ...
     * @return string
     */
    public function extract(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Parser $parser, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Node\Variable $var, $data)
    {
        $value = $data;
