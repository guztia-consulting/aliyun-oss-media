 ...
 * Description
 */
class Expression extends \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Node\Abstraction
{
    /**
    ...
    public function __construct($token, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Operator\Abstraction $operator, array $variables = null, $forwardLookupSeparator = null)
    {
