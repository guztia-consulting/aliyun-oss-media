...
namespace GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize;
...
class UriTemplate
{
    ...
    public function __construct($base_uri = '', $params = array(), \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Parser $parser = null)
    {
    ...
    protected function createNodeParser()
    {
        ...
        return $parser = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Rize\UriTemplate\Parser();
    }
}
