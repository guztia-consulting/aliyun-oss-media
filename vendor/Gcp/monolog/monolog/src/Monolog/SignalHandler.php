...
class SignalHandler
{
    ...
    public function registerSignalHandler($signo, $level = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Psr\Log\LogLevel::CRITICAL, bool $callPrevious = true, bool $restartSyscalls = true, ?bool $async = true) : self
    {
    ...
    public function handleSignal($signo, array $siginfo = null) : void
    {
        ...
        $level = $this->signalLevelMap[$signo] ?? \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Psr\Log\LogLevel::CRITICAL;
