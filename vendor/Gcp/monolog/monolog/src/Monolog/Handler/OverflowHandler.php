 ...
 */
class OverflowHandler extends \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Handler\AbstractHandler implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Handler\FormattableHandlerInterface
{
    /** @var HandlerInterface */
    private $handler;
    /** @var int[] */
    private $thresholdMap = [\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::DEBUG => 0, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::INFO => 0, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::NOTICE => 0, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::WARNING => 0, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::ERROR => 0, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::CRITICAL => 0, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::ALERT => 0, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::EMERGENCY => 0];
    /**
     ...
     * @param bool             $bubble
     */
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Handler\HandlerInterface $handler, array $thresholdMap = [], $level = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::DEBUG, bool $bubble = true)
    {
