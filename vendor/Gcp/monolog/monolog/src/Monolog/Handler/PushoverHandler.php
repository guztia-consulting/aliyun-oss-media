 ...
 */
class PushoverHandler extends \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct(string $token, $users, ?string $title = null, $level = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::CRITICAL, bool $bubble = true, bool $useSSL = true, $highPriorityLevel = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::CRITICAL, $emergencyLevel = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::EMERGENCY, int $retry = 30, int $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
    ...
    private function buildContent(array $record) : string
    {
        ...
        $message = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Utils::substr($message, 0, $maxMessageLength);
    ...
    {
        $this->highPriorityLevel = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::toMonologLevel($value);
        return $this;
    }
    public function setEmergencyLevel($value) : self
    {
        $this->emergencyLevel = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::toMonologLevel($value);
        return $this;
    }
    /**
