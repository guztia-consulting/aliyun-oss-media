 ...
 */
class TestHandler extends \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Handler\AbstractProcessingHandler
{
    protected $records = [];
    ...
    {
        return isset($this->recordsByLevel[\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::toMonologLevel($level)]);
    }
    /**
    ...
    {
        $level = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::toMonologLevel($level);
    ...
    public function __call($method, $args)
    {
        if (preg_match('/(.*)(Debug|Info|Notice|Warning|Error|Critical|Alert|Emergency)(.*)/', $method, $matches) > 0) {
            ...
            $level = constant('GuztiaConsulting\\Aliyun_OSS_Media\\Gcp\\Monolog\\Logger::' . strtoupper($matches[2]));
