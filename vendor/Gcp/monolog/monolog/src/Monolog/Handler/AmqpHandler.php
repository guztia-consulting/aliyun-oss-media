...
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Formatter\JsonFormatter;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\PhpAmqpLib\Message\AMQPMessage;
use GuztiaConsulting\Aliyun_OSS_Media\Gcp\PhpAmqpLib\Channel\AMQPChannel;
use AMQPExchange;
class AmqpHandler extends \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($exchange, ?string $exchangeName = null, $level = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::DEBUG, bool $bubble = true)
    {
    ...
    {
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\PhpAmqpLib\Message\AMQPMessage($data, ['delivery_mode' => 2, 'content_type' => 'application/json']);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Formatter\JsonFormatter(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Formatter\JsonFormatter::BATCH_MODE_JSON, false);
    }
}
