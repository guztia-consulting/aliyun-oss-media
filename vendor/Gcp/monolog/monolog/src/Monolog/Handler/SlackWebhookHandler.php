 ...
 */
class SlackWebhookHandler extends \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Handler\AbstractProcessingHandler
{
    /**
     * Slack Webhook token
     * @var string
    ...
    protected function write(array $record) : void
    {
        ...
        $postString = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Utils::jsonEncode($postData);
        $ch = curl_init();
        ...
        \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Handler\Curl\Util::execute($ch);
    }
