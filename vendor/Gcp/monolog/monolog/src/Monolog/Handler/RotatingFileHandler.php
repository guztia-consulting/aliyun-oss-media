 ...
 */
class RotatingFileHandler extends \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct(string $filename, int $maxFiles = 0, $level = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::DEBUG, bool $bubble = true, ?int $filePermission = null, bool $useLocking = false)
    {
        $this->filename = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Utils::canonicalizePath($filename);
