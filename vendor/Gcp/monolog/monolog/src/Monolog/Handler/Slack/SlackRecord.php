 ...
 */
namespace GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Handler\Slack;
...
class SlackRecord
{
    ...
    public function __construct(?string $channel = null, ?string $username = null, bool $useAttachment = true, ?string $userIcon = null, bool $useShortAttachment = false, bool $includeContextAndExtra = false, array $excludeFields = array(), \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Formatter\NormalizerFormatter();
        }
    }
    /**
    ...
    {
        switch (true) {
            case $level >= \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::ERROR:
                return static::COLOR_DANGER;
            case $level >= \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::WARNING:
                return static::COLOR_WARNING;
            case $level >= \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Logger::INFO:
    ...
    public function stringify(array $fields) : string
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Utils::jsonEncode($normalized, JSON_PRETTY_PRINT | \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Utils::DEFAULT_JSON_FLAGS) : \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Utils::jsonEncode($normalized, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Utils::DEFAULT_JSON_FLAGS);
    }
    /**
