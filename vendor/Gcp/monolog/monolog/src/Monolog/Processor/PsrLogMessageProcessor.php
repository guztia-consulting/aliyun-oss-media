 ...
 */
class PsrLogMessageProcessor implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Processor\ProcessorInterface
{
    ...
    public function __invoke(array $record) : array
    {
        ...
        foreach ($record['context'] as $key => $val) {
            ...
            if (is_null($val) || is_scalar($val) || is_object($val) && method_exists($val, "__toString")) {
                ...
                $replacements[$placeholder] = '[object ' . \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Utils::getClass($val) . ']';
            } elseif (is_array($val)) {
