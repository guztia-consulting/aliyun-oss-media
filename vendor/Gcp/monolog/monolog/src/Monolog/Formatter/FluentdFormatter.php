 ...
 */
class FluentdFormatter implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Formatter\FormatterInterface
{
    /**
    ...
    public function format(array $record) : string
    {
        ...
        return \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Utils::jsonEncode([$tag, $record['datetime']->getTimestamp(), $message]);
    }
