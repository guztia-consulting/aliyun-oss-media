 ...
 */
class LineFormatter extends \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Formatter\NormalizerFormatter
{
    ...
    {
        $str = '[object] (' . \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Monolog\Utils::getClass($e) . '(code: ' . $e->getCode();
