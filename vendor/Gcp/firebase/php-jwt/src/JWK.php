...
class JWK
{
    ...
    public static function parseKeySet(array $jwks)
    {
        ...
        if (empty($jwks['keys'])) {
            throw new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Firebase\JWT\InvalidArgumentException('JWK Set did not contain any keys');
        }
    ...
    {
        if (empty($jwk)) {
            throw new \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Firebase\JWT\InvalidArgumentException('JWK must not be empty');
        }
        if (!isset($jwk['kty'])) {
    ...
    {
        $modulus = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Firebase\JWT\JWT::urlsafeB64Decode($n);
        $publicExponent = \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Firebase\JWT\JWT::urlsafeB64Decode($e);
