...
class RetryMiddleware
{
     ...
     */
    private function onFulfilled(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Psr\Http\Message\RequestInterface $request, array $options) : callable
    {
     ...
     */
    private function onRejected(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Psr\Http\Message\RequestInterface $req, array $options) : callable
    {
    ...
    private function doRetry(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Psr\Http\Message\RequestInterface $request, array $options, \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Psr\Http\Message\ResponseInterface $response = null) : PromiseInterface
    {
