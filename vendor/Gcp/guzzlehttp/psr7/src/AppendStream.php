 ...
 */
class AppendStream implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \GuztiaConsulting\Aliyun_OSS_Media\Gcp\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
