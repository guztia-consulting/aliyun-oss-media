 ...
 */
class FnStream implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
