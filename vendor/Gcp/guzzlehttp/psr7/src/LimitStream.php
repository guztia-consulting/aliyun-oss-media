 ...
 */
class LimitStream implements \GuztiaConsulting\Aliyun_OSS_Media\Gcp\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Gcp\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
