 ...
 * @internal
 */
class ApiCallAttemptMonitoringMiddleware extends \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ClientSideMonitoring\AbstractMonitoringMiddleware
{
    /**
    ...
    private static function getResultAttemptLatency(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ResultInterface $result)
    {
    ...
    private static function getResultDestinationIp(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ResultInterface $result)
    {
        if (isset($result['@metadata']['transferStats']['http'])) {
            $attempt = end($result['@metadata']['transferStats']['http']);
    ...
    private static function getResultDnsLatency(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ResultInterface $result)
    {
        if (isset($result['@metadata']['transferStats']['http'])) {
            $attempt = end($result['@metadata']['transferStats']['http']);
    ...
    private static function getResultHttpStatusCode(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ResultInterface $result)
    {
        return $result['@metadata']['statusCode'];
    }
    private static function getAwsExceptionAttemptLatency(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Exception\AwsException $e)
    {
    ...
    private static function getAwsExceptionErrorCode(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Exception\AwsException $e)
    {
        return $e->getAwsErrorCode();
    }
    private static function getAwsExceptionMessage(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Exception\AwsException $e)
    {
        return $e->getAwsErrorMessage();
    }
    private static function getAwsExceptionDestinationIp(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Exception\AwsException $e)
    {
        $attempt = $e->getTransferInfo();
        if (isset($attempt['primary_ip'])) {
            return $attempt['primary_ip'];
    ...
    private static function getAwsExceptionDnsLatency(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Exception\AwsException $e)
    {
        $attempt = $e->getTransferInfo();
        if (isset($attempt['namelookup_time'])) {
            return (int) floor($attempt['namelookup_time'] * 1000);
    ...
    private static function getAwsExceptionHttpStatusCode(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Exception\AwsException $e)
    {
