 ...
 * @internal
 */
class ApiCallMonitoringMiddleware extends \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ClientSideMonitoring\AbstractMonitoringMiddleware
{
    /**
    ...
    private static function getResultAttemptCount(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ResultInterface $result)
    {
