...
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\AbstractConfigurationProvider;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\CacheInterface;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ClientSideMonitoring\Exception\ConfigurationException;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ConfigurationProviderInterface;
 ...
 * </code>
 */
class ConfigurationProvider extends \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\AbstractConfigurationProvider implements \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ConfigurationProviderInterface
{
    ...
    protected static $interfaceClass = \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ClientSideMonitoring\ConfigurationInterface::class;
    protected static $exceptionClass = \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ClientSideMonitoring\Exception\ConfigurationException::class;
    /**
    ...
    public static function env()
    {
        return function () {
            ...
            if ($enabled !== false) {
                return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\promise_for(new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ClientSideMonitoring\Configuration($enabled, getenv(self::ENV_HOST) ?: self::DEFAULT_HOST, getenv(self::ENV_PORT) ?: self::DEFAULT_PORT, getenv(self::ENV_CLIENT_ID) ?: self::DEFAULT_CLIENT_ID));
            }
    ...
    {
        return function () {
            return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\promise_for(new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ClientSideMonitoring\Configuration(self::DEFAULT_ENABLED, self::DEFAULT_HOST, self::DEFAULT_PORT, self::DEFAULT_CLIENT_ID));
        };
    }
    /**
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use($profile, $filename) {
            ...
            $data = \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\parse_ini_file($filename, true);
            if ($data === false) {
            ...
            return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\promise_for(new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ClientSideMonitoring\Configuration($data[$profile]['csm_enabled'], $data[$profile]['csm_host'], $data[$profile]['csm_port'], $data[$profile]['csm_client_id']));
        };
    }
    /**
    ...
    public static function unwrap($config)
    {
        ...
        if ($config instanceof ConfigurationInterface) {
            ...
            return new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ClientSideMonitoring\Configuration($config['enabled'], $host, $port, $client_id);
        }
