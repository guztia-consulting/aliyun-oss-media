...
abstract class AbstractCryptoClientV2
{
    ...
    public static $supportedKeyWraps = [\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\KmsMaterialsProviderV2::WRAP_ALGORITHM_NAME];
     ...
     * @internal
     */
    public abstract function encrypt(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Psr7\Stream $plaintext, array $options, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\MaterialsProviderV2 $provider, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\MetadataEnvelope $envelope);
    /**
     ...
     * @internal
     */
    public abstract function decrypt($cipherText, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\MaterialsProviderInterfaceV2 $provider, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\MetadataEnvelope $envelope, array $options = []);
}
