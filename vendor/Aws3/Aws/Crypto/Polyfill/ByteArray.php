...
class ByteArray extends \SplFixedArray
{
    ...
    {
        return new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\Polyfill\ByteArray(\pack('N', $num));
    }
    /**
     * @param ByteArray $other
     * @return bool
     */
    public function equals(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\Polyfill\ByteArray $other)
    {
     ...
     * @return ByteArray
     */
    public function exclusiveOr(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\Polyfill\ByteArray $array)
    {
     ...
     * @return ByteArray
     */
    public static function select($select, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\Polyfill\ByteArray $left, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\Polyfill\ByteArray $right)
    {
     ...
     * @return self
     */
    public function set(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\Polyfill\ByteArray $input, $offset = 0, $length = null)
    {
    ...
    {
        return new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\Polyfill\ByteArray(\array_slice($this->toArray(), $start, $length));
    }
    /**
