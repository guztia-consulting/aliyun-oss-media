 ...
 * @deprecated
 */
class KmsMaterialsProvider extends \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\MaterialsProvider implements \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\MaterialsProviderInterface
{
    ...
    public function fromDecryptionEnvelope(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\MetadataEnvelope $envelope)
    {
        if (empty($envelope[\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\MetadataEnvelope::MATERIALS_DESCRIPTION_HEADER])) {
            throw new \RuntimeException('Not able to detect the materials description.');
        }
        $materialsDescription = json_decode($envelope[\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\MetadataEnvelope::MATERIALS_DESCRIPTION_HEADER], true);
