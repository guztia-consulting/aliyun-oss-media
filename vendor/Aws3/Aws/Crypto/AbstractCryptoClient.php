...
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\Cipher\CipherMethod;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\Cipher\Cbc;
...
abstract class AbstractCryptoClient
{
    ...
    public static $supportedKeyWraps = [\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\KmsMaterialsProvider::WRAP_ALGORITHM_NAME];
    /**
     ...
     * @internal
     */
    public abstract function encrypt(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Psr7\Stream $plaintext, array $cipherOptions, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\MaterialsProvider $provider, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\MetadataEnvelope $envelope);
    /**
     ...
     * @internal
     */
    public abstract function decrypt($cipherText, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\MaterialsProviderInterface $provider, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\MetadataEnvelope $envelope, array $cipherOptions = []);
}
