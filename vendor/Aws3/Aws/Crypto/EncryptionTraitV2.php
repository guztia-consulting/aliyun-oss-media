...
trait EncryptionTraitV2
{
    ...
    private static $encryptClasses = ['gcm' => \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\AesGcmEncryptingStream::class];
    /**
     ...
     * @internal
     */
    public function encrypt(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Psr7\Stream $plaintext, array $options, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\MaterialsProviderV2 $provider, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\MetadataEnvelope $envelope)
    {
        ...
        if (!\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\MaterialsProviderV2::isSupportedKeySize($cipherOptions['KeySize'])) {
        ...
        $envelope[\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\MetadataEnvelope::CONTENT_KEY_V2_HEADER] = $keys['Ciphertext'];
        unset($keys);
