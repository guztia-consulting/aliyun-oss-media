...
class JsonBody
{
     ...
     * @return string
     */
    public static function getContentType(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\Service $service)
    {
    ...
    private function format(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\Shape $shape, $value)
    {
        switch ($shape['type']) {
            case 'structure':
                $data = [];
            ...
            case 'timestamp':
                ...
                return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\TimestampShape::format($value, $timestampFormat);
            default:
                return $value;
        }
    }
