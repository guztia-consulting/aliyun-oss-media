 ...
 * @internal
 */
class RestJsonSerializer extends \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\Serializer\RestSerializer
{
    /** @var JsonBody */
    ...
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\Service $api, $endpoint, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\Serializer\JsonBody $jsonFormatter = null)
    {
        ...
        $this->jsonFormatter = $jsonFormatter ?: new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\Serializer\JsonBody($api);
    }
