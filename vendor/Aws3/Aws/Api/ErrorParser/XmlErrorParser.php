...
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\Parser\XmlParser;
 ...
 * Parses XML errors.
 */
class XmlErrorParser extends \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\ErrorParser\AbstractErrorParser
{
    use PayloadParserTrait;
    protected $parser;
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\Service $api = null, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\Parser\XmlParser $parser = null)
    {
    ...
    private function parseHeaders(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Psr\Http\Message\ResponseInterface $response, array &$data)
    {
