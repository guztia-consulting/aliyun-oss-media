 ...
 */
class Operation extends \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\AbstractModel
{
    private $input;
    private $output;
    private $errors;
    ...
    public function getInput()
    {
        if (!$this->input) {
            if ($input = $this['input']) {
                ...
                $this->input = new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\StructureShape([], $this->shapeMap);
            }
        }
        return $this->input;
    }
    ...
    public function getOutput()
    {
        if (!$this->output) {
            if ($output = $this['output']) {
                ...
                $this->output = new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\StructureShape([], $this->shapeMap);
            }
        }
        return $this->output;
    }
