 ...
 */
class CommandPool implements \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\PromisorInterface
{
    /** @var EachPromise */
    private $each;
    /**
     ...
     */
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\AwsClientInterface $client, $commands, array $config = [])
    {
        ...
        $this->each = new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\EachPromise($mapFn($commands), $config);
    }
    /**
     ...
     */
    public static function batch(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\AwsClientInterface $client, $commands, array $config = [])
    {
        $results = [];
