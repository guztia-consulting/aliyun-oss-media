...
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\EndpointDiscovery\Exception\ConfigurationException;
...
class ConfigurationProvider extends \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\AbstractConfigurationProvider implements \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ConfigurationProviderInterface
{
    ...
    protected static $interfaceClass = \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\EndpointDiscovery\ConfigurationInterface::class;
    protected static $exceptionClass = \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\EndpointDiscovery\Exception\ConfigurationException::class;
    /**
    ...
    public static function env($cacheLimit = self::DEFAULT_CACHE_LIMIT)
    {
        return function () use($cacheLimit) {
            ...
            if ($enabled !== false && $enabled !== '') {
                return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\promise_for(new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\EndpointDiscovery\Configuration($enabled, $cacheLimit));
            }
    ...
    public static function fallback($config = [])
    {
        ...
        return function () use($enabled) {
            return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\promise_for(new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\EndpointDiscovery\Configuration($enabled, self::DEFAULT_CACHE_LIMIT));
        };
    }
    /**
    ...
    public static function ini($profile = null, $filename = null, $cacheLimit = self::DEFAULT_CACHE_LIMIT)
    {
        ...
        return function () use($profile, $filename, $cacheLimit) {
            ...
            return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\promise_for(new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\EndpointDiscovery\Configuration($data[$profile]['endpoint_discovery_enabled'], $cacheLimit));
        };
    }
    /**
    ...
    public static function unwrap($config)
    {
        ...
        if ($config instanceof ConfigurationInterface) {
            ...
            if (isset($config['cache_limit'])) {
                return new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\EndpointDiscovery\Configuration($config['enabled'], $config['cache_limit']);
            }
            return new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\EndpointDiscovery\Configuration($config['enabled'], self::DEFAULT_CACHE_LIMIT);
        }
