...
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\DecryptionTraitV2;
...
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\AbstractCryptoClientV2;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\EncryptionTraitV2;
...
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\Cipher\CipherBuilderTrait;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\S3Client;
 ...
 * </code>
 */
class S3EncryptionClientV2 extends \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\AbstractCryptoClientV2
{
     ...
     */
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\S3Client $client, $instructionFileSuffix = null)
    {
    ...
    public function putObjectAsync(array $args)
    {
        ...
        return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\promise_for($this->encrypt(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Psr7\stream_for($args['Body']), $args, $provider, $envelope))->then(function ($encryptedBodyStream) use($args) {
            $hash = new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\PhpHash('sha256');
            $hashingEncryptedBodyStream = new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\HashingStream($encryptedBodyStream, $hash, self::getContentShaDecorator($args));
    ...
    public function getObjectAsync(array $args)
    {
        ...
        if (!isset($args['@SecurityProfile']) || !in_array($args['@SecurityProfile'], self::$supportedSecurityProfiles)) {
            throw new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Exception\CryptoException("@SecurityProfile is required and must be" . " set to 'V2' or 'V2_AND_LEGACY'");
        }
