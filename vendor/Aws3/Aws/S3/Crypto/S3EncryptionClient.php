...
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\DecryptionTrait;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\HashingStream;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\PhpHash;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\AbstractCryptoClient;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\EncryptionTrait;
 ...
 * @deprecated
 */
class S3EncryptionClient extends \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Crypto\AbstractCryptoClient
{
    ...
    public function putObjectAsync(array $args)
    {
        ...
        return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\promise_for($this->encrypt(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Psr7\stream_for($args['Body']), $args['@CipherOptions'] ?: [], $provider, $envelope))->then(function ($encryptedBodyStream) use($args) {
