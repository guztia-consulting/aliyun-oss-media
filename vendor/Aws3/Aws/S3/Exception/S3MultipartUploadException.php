...
namespace GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\Exception;
...
class S3MultipartUploadException extends \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Exception\MultipartUploadException
{
     ...
     */
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Multipart\UploadState $state, $prev = null)
    {
     ...
     */
    private function collectPathInfo(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\CommandInterface $cmd)
    {
