...
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\DocModel;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\Service;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\AwsClient;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\CacheInterface;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ClientResolver;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Command;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Exception\AwsException;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\HandlerList;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\InputValidationMiddleware;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Middleware;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Retry\QuotaManager;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\RetryMiddleware;
...
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\RetryMiddlewareV2;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\UseArnRegion\Configuration;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\UseArnRegion\ConfigurationInterface;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\UseArnRegion\ConfigurationProvider as UseArnRegionConfigurationProvider;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\RegionalEndpoint\ConfigurationProvider;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Exception\RequestException;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\Promise;
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\PromiseInterface;
 ...
 */
class S3Client extends \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\AwsClient implements \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\S3ClientInterface
{
    use S3ClientTrait;
    /** @var array */
    ...
    public function __construct(array $args)
    {
        if (!isset($args['s3_us_east_1_regional_endpoint']) || $args['s3_us_east_1_regional_endpoint'] instanceof CacheInterface) {
            $args['s3_us_east_1_regional_endpoint'] = \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\RegionalEndpoint\ConfigurationProvider::defaultProvider($args);
        }
        parent::__construct($args);
        $stack = $this->getHandlerList();
        $stack->appendInit(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\SSECMiddleware::wrap($this->getEndpoint()->getScheme()), 's3.ssec');
        $stack->appendBuild(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\ApplyChecksumMiddleware::wrap($this->getApi()), 's3.checksum');
        $stack->appendBuild(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Middleware::contentType(['PutObject', 'UploadPart']), 's3.content_type');
        // Use the bucket style middleware when using a "bucket_endpoint" (for cnames)
        if ($this->getConfig('bucket_endpoint')) {
            $stack->appendBuild(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\BucketEndpointMiddleware::wrap(), 's3.bucket_endpoint');
        } else {
            $stack->appendBuild(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\S3EndpointMiddleware::wrap($this->getRegion(), $this->getConfig('endpoint_provider'), ['dual_stack' => $this->getConfig('use_dual_stack_endpoint'), 'accelerate' => $this->getConfig('use_accelerate_endpoint'), 'path_style' => $this->getConfig('use_path_style_endpoint')]), 's3.endpoint_middleware');
        }
        ...
        $stack->appendValidate(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\InputValidationMiddleware::wrap($this->getApi(), self::$mandatoryAttributes), 'input_validation_middleware');
        $stack->appendSign(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\PutObjectUrlMiddleware::wrap(), 's3.put_object_url');
        $stack->appendSign(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\PermanentRedirectMiddleware::wrap(), 's3.permanent_redirect');
        $stack->appendInit(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Middleware::sourceFile($this->getApi()), 's3.source_file');
    ...
    public static function _apply_use_arn_region($value, array &$args, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\HandlerList $list)
    {
        if ($value instanceof CacheInterface) {
            $value = \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\UseArnRegion\ConfigurationProvider::defaultProvider($args);
        }
        ...
        if ($value instanceof ConfigurationInterface) {
            ...
            $args['use_arn_region'] = new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\UseArnRegion\Configuration($value);
        }
    }
    public function createPresignedRequest(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\CommandInterface $command, $expires, array $options = [])
    {
        ...
        return $signer->presign(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\serialize($command), $this->getCredentials()->wait(), $expires, $options);
    }
    /**
    ...
    public function getObjectUrl($bucket, $key)
    {
        ...
        return (string) \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\serialize($command)->getUri();
    }
    /**
    ...
    private function getLocationConstraintMiddleware()
    {
        ...
        return static function (callable $handler) use($region) {
            return function (\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Command $command, $request = null) use($handler, $region) {
    ...
    private function getSaveAsParameter()
    {
        return static function (callable $handler) {
            return function (\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Command $command, $request = null) use($handler) {
    ...
    {
        return static function (callable $handler) {
            return function (\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\CommandInterface $command, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Psr\Http\Message\RequestInterface $request = null) use($handler) {
    ...
    private function getEncodingTypeMiddleware()
    {
        return static function (callable $handler) {
            return function (\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Command $command, $request = null) use($handler) {
                ...
                return $handler($command, $request)->then(function (\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ResultInterface $result) use($autoSet) {
    ...
    /** @internal */
    public static function _applyRetryConfig($value, $args, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\HandlerList $list)
    {
        if ($value) {
            ...
            if ($config->getMode() === 'legacy') {
                ...
                $decider = \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\RetryMiddleware::createDefaultDecider($maxRetries);
                ...
                $delay = [\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\RetryMiddleware::class, 'exponentialDelay'];
                $list->appendSign(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Middleware::retry($decider, $delay), 'retry');
            } else {
                $defaultDecider = \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\RetryMiddlewareV2::createDefaultDecider(new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Retry\QuotaManager(), $config->getMaxAttempts());
                $list->appendSign(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\RetryMiddlewareV2::wrap($config, ['collect_stats' => $args['stats']['retries'], 'decider' => function ($attempts, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\CommandInterface $cmd, $result) use($defaultDecider, $config) {
    ...
    /** @internal */
    public static function _applyApiProvider($value, array &$args, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\HandlerList $list)
    {
        \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ClientResolver::_apply_api_provider($value, $args);
        $args['parser'] = new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\GetBucketLocationParser(new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\AmbiguousSuccessParser(new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\RetryableMalformedResponseParser($args['parser'], $args['exception_class']), $args['error_parser'], $args['exception_class']));
    }
    /**
     * @internal
     * @codeCoverageIgnore
    ...
    public static function applyDocFilters(array $api, array $docs)
    {
        ...
        return [new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\Service($api, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\ApiProvider::defaultProvider()), new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Api\DocModel($docs)];
    }
    /**
     * @internal
     * @codeCoverageIgnore
