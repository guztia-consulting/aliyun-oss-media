...
class ConfigurationProvider extends \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\AbstractConfigurationProvider implements \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ConfigurationProviderInterface
{
    ...
    protected static $interfaceClass = \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\UseArnRegion\ConfigurationInterface::class;
    protected static $exceptionClass = \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\UseArnRegion\Exception\ConfigurationException::class;
    /**
    ...
    public static function env()
    {
        return function () {
            ...
            if (!empty($useArnRegion)) {
                return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\promise_for(new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\UseArnRegion\Configuration($useArnRegion));
            }
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use($profile, $filename) {
            ...
            $data = \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\parse_ini_file($filename, true, INI_SCANNER_NORMAL);
            if ($data === false) {
            ...
            return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\promise_for(new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\UseArnRegion\Configuration($data[$profile][self::INI_USE_ARN_REGION]));
        };
    }
    /**
    ...
    {
        return function () {
            return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\promise_for(new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\UseArnRegion\Configuration(self::DEFAULT_USE_ARN_REGION));
        };
    }
}
