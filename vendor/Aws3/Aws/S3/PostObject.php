...
class PostObject
{
     ...
     *                                      behalf.
     */
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\S3\S3ClientInterface $client, $bucket, array $formInputs, $jsonPolicy)
    {
        $this->client = $client;
        $this->bucket = $bucket;
    ...
    protected function getPolicyAndSignature(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Credentials\CredentialsInterface $creds)
    {
