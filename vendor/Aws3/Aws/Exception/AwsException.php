...
use GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Env as JmesPath;
 ...
 */
class AwsException extends \RuntimeException implements \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\MonitoringEventsInterface, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\ResponseContainerInterface, \ArrayAccess
{
    use HasDataTrait;
     ...
     */
    public function __construct($message, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\CommandInterface $command, array $context = [], \Exception $previous = null)
    {
    ...
    {
        return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Env::search($expression, $this->toArray());
    }
}
