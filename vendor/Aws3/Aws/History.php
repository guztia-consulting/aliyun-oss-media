...
class History implements \Countable, \IteratorAggregate
{
     ...
     */
    public function start(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\CommandInterface $cmd, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Psr\Http\Message\RequestInterface $req)
    {
        $ticket = uniqid();
