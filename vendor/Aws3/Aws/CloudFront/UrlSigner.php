...
namespace GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\CloudFront;
...
class UrlSigner
{
    ...
    {
        $this->signer = new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\CloudFront\Signer($keyPairId, $privateKey);
    }
    /**
    ...
    public function getSignedUrl($url, $expires = null, $policy = null)
    {
        ...
        $uri = new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Psr7\Uri($scheme . '://' . $urlSections[1]);
        $query = \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Psr7\parse_query($uri->getQuery(), PHP_QUERY_RFC3986);
    ...
    private function createRtmpUrl(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Psr\Http\Message\UriInterface $uri)
    {
