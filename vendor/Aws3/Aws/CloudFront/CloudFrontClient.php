 ...
 */
class CloudFrontClient extends \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\AwsClient
{
    /**
    ...
    public function getSignedUrl(array $options)
    {
        ...
        $urlSigner = new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\CloudFront\UrlSigner($options['key_pair_id'], $options['private_key']);
    ...
    public function getSignedCookie(array $options)
    {
        ...
        $cookieSigner = new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\CloudFront\CookieSigner($options['key_pair_id'], $options['private_key']);
