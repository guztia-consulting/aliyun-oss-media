...
function default_http_handler()
{
    ...
    if ($version === 6 || $version === 7) {
        return new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Handler\GuzzleV6\GuzzleHandler();
    }
    // If Guzzle 5 installed
    if ($version === 5) {
        return new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Handler\GuzzleV5\GuzzleHandler();
    }
...
function default_user_agent()
{
    ...
    // If Guzzle 6 or 7 installed
    if ($version === 6 || $version === 7) {
        return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\default_user_agent();
    }
    // If Guzzle 5 installed
    if ($version === 5) {
        return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Client::getDefaultUserAgent();
    }
    throw new \RuntimeException('Unknown Guzzle version: ' . $version);
}
/**
...
function guzzle_major_version()
{
    ...
    if (defined('GuztiaConsulting\\Aliyun_OSS_Media\\Aws3\\GuzzleHttp\\ClientInterface::VERSION')) {
        $version = (string) \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\ClientInterface::VERSION;
        if ($version[0] === '6') {
            return $cache = 6;
        }
        if ($version[0] === '5') {
    ...
    } elseif (defined('GuztiaConsulting\\Aliyun_OSS_Media\\Aws3\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
        return $cache = \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\ClientInterface::MAJOR_VERSION;
    }
 ...
 * @throws \RuntimeException
 */
function serialize(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\CommandInterface $command)
{
    $request = null;
    $handlerList = $command->getHandlerList();
    // Return a mock result.
    $handlerList->setHandler(function (\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\CommandInterface $_, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Psr\Http\Message\RequestInterface $r) use(&$request) {
        $request = $r;
        return new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\FulfilledPromise(new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\Result([]));
    });
