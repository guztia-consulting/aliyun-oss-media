...
class MockHandler implements \Countable
{
    ...
    public function __invoke(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\Aws\CommandInterface $command, \GuztiaConsulting\Aliyun_OSS_Media\Aws3\Psr\Http\Message\RequestInterface $request)
    {
        ...
        if ($result instanceof \Exception) {
            $result = new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\RejectedPromise($result);
        } else {
            ...
            $result = \GuztiaConsulting\Aliyun_OSS_Media\Aws3\GuzzleHttp\Promise\promise_for($result);
        }
