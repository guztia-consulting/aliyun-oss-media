...
class TreeInterpreter
{
    ...
    {
        $this->fnDispatcher = $fnDispatcher ?: \GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\FnDispatcher::getInstance();
    }
    /**
    ...
    private function dispatch(array $node, $value)
    {
        ...
        switch ($node['type']) {
            ...
            case 'index':
                if (!\GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Utils::isArray($value)) {
                    return null;
                }
            ...
            case 'projection':
                ...
                switch ($node['from']) {
                    case 'object':
                        if (!\GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Utils::isObject($left)) {
                            return null;
                        }
                        break;
                    case 'array':
                        if (!\GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Utils::isArray($left)) {
                            return null;
                        }
                        break;
                    default:
            ...
            case 'or':
                ...
                return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Utils::isTruthy($result) ? $result : $this->dispatch($node['children'][1], $value);
            case 'and':
                $result = $this->dispatch($node['children'][0], $value);
                return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Utils::isTruthy($result) ? $this->dispatch($node['children'][1], $value) : $result;
            case 'not':
                return !\GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Utils::isTruthy($this->dispatch($node['children'][0], $value));
            case 'pipe':
                return $this->dispatch($node['children'][1], $this->dispatch($node['children'][0], $value));
            ...
            case 'comparator':
                ...
                if ($node['value'] == '==') {
                    return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Utils::isEqual($left, $right);
                } elseif ($node['value'] == '!=') {
                    return !\GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Utils::isEqual($left, $right);
                } else {
            ...
            case 'condition':
                return \GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Utils::isTruthy($this->dispatch($node['children'][0], $value)) ? $this->dispatch($node['children'][1], $value) : null;
            case 'function':
                $args = [];
            ...
            case 'slice':
                return is_string($value) || \GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Utils::isArray($value) ? \GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Utils::slice($value, $node['value'][0], $node['value'][1], $node['value'][2]) : null;
            case 'expref':
