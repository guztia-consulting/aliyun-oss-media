...
class DebugRuntime
{
    ...
    public function __construct(callable $runtime, $output = null)
    {
        ...
        $this->lexer = new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Lexer();
        $this->parser = new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Parser($this->lexer);
    }
    ...
    {
        $lexer = new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Lexer();
    ...
    {
        $parser = new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Parser();
