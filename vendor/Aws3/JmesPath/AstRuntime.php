...
class AstRuntime
{
    ...
    public function __construct(\GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Parser $parser = null, callable $fnDispatcher = null)
    {
        $fnDispatcher = $fnDispatcher ?: \GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\FnDispatcher::getInstance();
        $this->interpreter = new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\TreeInterpreter($fnDispatcher);
        $this->parser = $parser ?: new \GuztiaConsulting\Aliyun_OSS_Media\Aws3\JmesPath\Parser();
    }
    /**
