...
use GuztiaConsulting\Aliyun_OSS_Media\Items\Media_Library_Item;
use GuztiaConsulting\Aliyun_OSS_Media\Items\Item;
use GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\Another_CDN;
use GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\AWS_CloudFront;
use GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\Cloudflare;
use GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\Delivery_Provider;
use GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\DigitalOcean_Spaces_CDN;
use GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\GCP_CDN;
use GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\KeyCDN;
use GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\Other;
use GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\StackPath;
use GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\Storage;
use GuztiaConsulting\Aliyun_OSS_Media\Providers\Provider;
use GuztiaConsulting\Aliyun_OSS_Media\Providers\Storage\AWS_Provider;
use GuztiaConsulting\Aliyun_OSS_Media\Providers\Storage\Aliyun_Provider;
use GuztiaConsulting\Aliyun_OSS_Media\Providers\Storage\DigitalOcean_Provider;
use GuztiaConsulting\Aliyun_OSS_Media\Providers\Storage\GCP_Provider;
use GuztiaConsulting\Aliyun_OSS_Media\Providers\Storage\Null_Provider;
use GuztiaConsulting\Aliyun_OSS_Media\Providers\Storage\Storage_Provider;
use GuztiaConsulting\Aliyun_OSS_Media\Upgrades\Upgrade;
use GuztiaConsulting\Aliyun_OSS_Media\Upgrades\Upgrade_Content_Replace_URLs;
use GuztiaConsulting\Aliyun_OSS_Media\Upgrades\Upgrade_EDD_Replace_URLs;
use GuztiaConsulting\Aliyun_OSS_Media\Upgrades\Upgrade_File_Sizes;
use GuztiaConsulting\Aliyun_OSS_Media\Upgrades\Upgrade_Filter_Post_Excerpt;
use GuztiaConsulting\Aliyun_OSS_Media\Upgrades\Upgrade_Items_Table;
use GuztiaConsulting\Aliyun_OSS_Media\Upgrades\Upgrade_Meta_WP_Error;
use GuztiaConsulting\Aliyun_OSS_Media\Upgrades\Upgrade_Region_Meta;
use GuztiaConsulting\Aliyun_OSS_Media\Upgrades\Upgrade_WPOS3_To_AS3CF;
...
class Amazon_S3_And_CloudFront extends AS3CF_Plugin_Base {
	...
	function init( $plugin_file_path ) {
		$this->plugin_title      = __( 'Aliyun OSS for WP Media', 'amazon-s3-and-cloudfront' );
		$this->plugin_menu_title = __( 'Aliyun OSS for WP Media', 'amazon-s3-and-cloudfront' );

		static::$storage_provider_classes = apply_filters( 'as3cf_storage_provider_classes', array(
//			AWS_Provider::get_provider_key_name()          => 'GuztiaConsulting\Aliyun_OSS_Media\Providers\Storage\AWS_Provider',
			Aliyun_Provider::get_provider_key_name()       => 'GuztiaConsulting\Aliyun_OSS_Media\Providers\Storage\Aliyun_Provider',
//			DigitalOcean_Provider::get_provider_key_name() => 'GuztiaConsulting\Aliyun_OSS_Media\Providers\Storage\DigitalOcean_Provider',
//			GCP_Provider::get_provider_key_name()          => 'GuztiaConsulting\Aliyun_OSS_Media\Providers\Storage\GCP_Provider',
		) );

		static::$delivery_provider_classes = apply_filters( 'as3cf_delivery_provider_classes', array(
			AWS_CloudFront::get_provider_key_name()          => 'GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\AWS_CloudFront',
			DigitalOcean_Spaces_CDN::get_provider_key_name() => 'GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\DigitalOcean_Spaces_CDN',
			GCP_CDN::get_provider_key_name()                 => 'GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\GCP_CDN',
			Another_CDN::get_provider_key_name()             => 'GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\Another_CDN',
			// Sub Options of Another CDN.
			Cloudflare::get_provider_key_name()              => 'GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\Cloudflare',
			KeyCDN::get_provider_key_name()                  => 'GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\KeyCDN',
			StackPath::get_provider_key_name()               => 'GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\StackPath',
			Other::get_provider_key_name()                   => 'GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\Other',
			// Fallback to raw storage URLs.
			Storage::get_provider_key_name()                 => 'GuztiaConsulting\Aliyun_OSS_Media\Providers\Delivery\Storage',
		) );
	...
	private function handle_aws_access_key_migration() {
		...
		if ( is_plugin_active( 'amazon-web-services/amazon-web-services.php' ) ) {
			...
			if ( is_a( $this->get_storage_provider(), '\GuztiaConsulting\Aliyun_OSS_Media\Providers\Storage\AWS_Provider' ) && $this->get_storage_provider()->needs_access_keys() ) {
